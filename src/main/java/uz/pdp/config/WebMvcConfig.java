...
public class WebMvcConfig implements WebMvcConfigurer {
  ...
  @Bean
    public ClasseResponsitory getClasseDAO() {
        return new ClasseResponsitoryImpl(getDataSource());
    }
  @Bean
    public GroupsResponsitory getGroupDAO() {
        return new GroupsResponsitoryImpl(getDataSource());
    }
